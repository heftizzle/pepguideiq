  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        <div>
          <div className="mono" style={{ fontSize: 11, color: "#00d4aa", marginBottom: 5, letterSpacing: ".12em" }}>DOSE</div>
          <input className="form-input" value={dose} placeholder={peptide.startDose} onChange={(e) => setDose(e.target.value)} />
        </div>
        <div>
          <div className="mono" style={{ fontSize: 11, color: "#00d4aa", marginBottom: 5, letterSpacing: ".12em" }}>FREQUENCY</div>
          <input
        ...
        <div>
          <div className="mono" style={{ fontSize: 11, color: "#00d4aa", marginBottom: 5, letterSpacing: ".12em" }}>NOTES</div>
