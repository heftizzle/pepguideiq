  ...
  return (
    <style>{`
      ...
      *{box-sizing:border-box;margin:0;padding:0}
      ...
      .cat-btn{background:transparent;border:1px solid #14202e;color:#4a6080;padding:7px 16px;border-radius:20px;cursor:pointer;font-size:12px;white-space:nowrap;transition:all .2s;font-family:'Outfit',sans-serif}
      ...
      .dval{font-size:12px;color:#8fa5bf;flex:1;line-height:1.6}
