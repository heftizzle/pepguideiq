...
export const BATCH15 = [
...

  {
    ...
    category: ["Performance", "Nootropic", "Foundational Supplement"],
    categories: ["Performance", "Nootropic", "Foundational Supplement"],
    route: ["oral"],
    mechanism:
...

  {
    ...
    category: ["SARM", "Research Chemical"],
    categories: ["SARM", "Research Chemical"],
    route: ["oral"],
    mechanism:
...

  {
    ...
    category: ["Research Chemical", "Performance"],
    categories: ["Research Chemical", "Performance"],
