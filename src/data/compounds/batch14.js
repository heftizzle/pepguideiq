...
export const BATCH14 = [
...

  {
    ...
    category: ["Anabolic Steroid (Medical)", "AAS"],
    categories: ["Anabolic Steroid (Medical)", "AAS"],
    route: ["oral"],
    mechanism:
...

  {
    ...
    category: ["Diabetes Management", "Longevity", "Metabolic"],
    categories: ["Diabetes Management", "Longevity", "Metabolic"],
    route: ["oral"],
    mechanism:
...

  {
    ...
    category: ["Weight Management", "Methylation", "Compounded"],
    categories: ["Weight Management", "Methylation", "Compounded"],
...

  {
    ...
    category: ["Vitamin", "Energy Support", "Methylation"],
    categories: ["Vitamin", "Energy Support", "Methylation"],
    route: ["IM injection", "subQ injection"],
    mechanism:
