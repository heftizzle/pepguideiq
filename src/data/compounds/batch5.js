export const BATCH5 = [
  {
    ...
    sourcingNotes: "Available from research peptide vendors in multi-count capsule bottles. One of the most popular compounds on the platform. Best taken pre-sleep to align with natural GH pulse.",
    warnings: [
  ...
  },
  {
    ...
    sourcingNotes: "Available from research peptide vendors. One of the most potent SARMs — suppressive at higher doses. PCT consideration required.",
    warnings: [
  ...
  },
  {
    ...
    sourcingNotes:
      "Available from research peptide vendors. Development halted by GSK after carcinogenicity signals in animal studies. Community use continues — significant risk awareness required.",
    warnings: [
  ...
  },
  {
    ...
    sourcingNotes: "Available from research peptide vendors. Steroidal backbone — behaves more like a steroid than non-steroidal SARMs. Most suppressive SARM on the list.",
    warnings: [
  ...
  },
  {
    ...
    sourcingNotes: "Available from research peptide vendors. Most potent non-steroidal SARM. Studied as male contraceptive — complete spermatogenesis suppression at research doses.",
    warnings: [
  ...
  },
  {
    ...
    sourcingNotes: "Available from research peptide vendors. Very early research compound — animal data only. ERR mechanism is highly novel. Not androgenic.",
    warnings: [
