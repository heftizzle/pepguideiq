-- Fix get_network_feed: user_stacks has no stack_name column; label from share_id; surface updated_at for UI.
...
COMMENT ON FUNCTION public.get_network_feed() IS
  'Authenticated: network-visible stacks; stack_name derived from share_id; pepguideIQ score; ordered by updated_at DESC.';
